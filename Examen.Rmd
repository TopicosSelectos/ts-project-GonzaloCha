...
```
La gráfica anterior muestra el total de observaciones por año.
...
```
Esta gráfica nos muestra en que año y temporada empezó el proceso de recolección de datos.
...
```
Nos muestra el total de observaciones por cada genero.
...
SETAP %>%
  ...
  labs(x = "Año",y = "Observaciones") 
```
Esta gráfica nos muestra el total de observaciones por cada año y temporada de las mujeres.
...
SETAP %>%
  ...
  labs(x = "Año",y = "Observaciones")
```
Esta gráfica nos muestra el total de observaciones por cada año y temporada de los hombres.
...
```
Nos muestra el total de estudiantes en cada equipo.
...
ggplot(data = SETAP) + 
  ...
  labs(x = "Equipo",y = "Observaciones por equipo") 
```
Nos muestra el total de estudiantes en cada grupo por semestre.
...
ggplot(data = SETAP) + 
  ...
  labs(x = "Equipo",y = "Observaciones por equipo") 
```
Nos muestra el total de estudiantes en cada grupo por año.
